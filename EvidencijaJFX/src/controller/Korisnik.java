...
public class Korisnik implements Initializable {
    ...
    // public static Autori dodajAutore;
   ...
   /* @FXML
    ...
    /*
    public void ucitajAutore(ActionEvent ev ) throws IOException {
    ...
    */
    ...
    public void ucitajRezervacije(ActionEvent e) throws IOException{
        ...
        // border_pane.setCenter(rezervacija);
